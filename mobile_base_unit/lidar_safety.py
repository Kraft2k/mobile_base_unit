...
from mobile_base_unit.utils import angle_diff
...
class LidarSafety:
    def __init__(self, safety_distance: float, critical_distance: float, robot_collision_radius: float,
        ...
        - Unit's speed is slowed down if the direction of speed matches the direction of at least 1 LIDAR point in
        the safety_distance range
        - Units's speed is changed to 0 if the direction of speed matches the direction of at least 1 LIDAR point in
        ...
        # List of [center_angle, angle_width]. e.g. the forbidden angle is center_angle 
        self.unsafe_angles = []

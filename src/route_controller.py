...
class RouteController(Node):
    ...
    def __init__(self):
        ...
        self.get_logger().info("Route controller has been started")
        self.get_logger().info("For START record press button 'Circle' and for STOP button 'Square' on joystick")
